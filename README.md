...
# Actividad 4 - Programas hechos en clases
...
## Resolver los problemas que se plantean en el archivo anexo, para cada uno, elaborar un programa en Python que resuelva el problema:
